...
<nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
    ...
    <a class="navbar-brand" href="<?= base_url();?>admin_dashboard" style="margin-left: 1%;">
        <img src="<?php echo base_url('img/logowhite.png');?>" width="90" height="40" class="d-inline-block align-top" alt="">
    </a>
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
        <ul class="navbar-nav">
            <li class="nav-item active">
                  <a class="nav-link muted" href="#" style="font-weight: bold; text-transform: uppercase;">Admin Dashboard<span class="sr-only">(current)</span></a>
              </li>
