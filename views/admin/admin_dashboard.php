...
<div class="container" style="padding-top: 5%;">
	<h1 style="font-weight: bold; text-transform: uppercase;">Coeus - Admin Dashboard</h1>
</div>
 ...
 <table class="table table-bordered table-hover">
  ...
  <tbody>
    <tr>
      <td scope="row" >
        <form action="<?= site_url('admin/add_speaker');?>" method="post" class="form-group ">
          <div class="container">
          <div class="row">
            <div class="col-sm">
            ...
            <div class="col-sm">
              ...
              <div class="form-control" style="border-color: #FFFFFF;">
                ...
                <?php echo form_error('a','<p class="help-block text-danger">','</p>'); ?>
                    </div>
                    <div class="form-control" style="border-color: #FFFFFF;">
                      <div class="radio">
                         <label>Gender: </label>
...
<table class="table table-bordered table-hover" style="text-align: center;">
  ...
  <tbody>
     <form action="<?= site_url('admin/add_category');?>" method="post" class="form-group ">
    <tr>
      <td scope="row"> 
        <?php  
                if(!empty($success_msg)){ 
