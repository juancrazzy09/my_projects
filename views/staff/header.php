...
<nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
    ...
    <a class="navbar-brand" href="#" style="margin-left: 1%;">
        <img src="<?php echo base_url('img/logowhite.png');?>" width="60" height="30" class="d-inline-block align-top" alt="">
        <span class="menu-collapsed">Coeus</span>
    </a>
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
        <ul class="navbar-nav">
            <li class="nav-item active">
                  <a class="nav-link muted" href="#">Staff Dashboard<span class="sr-only">(current)</span></a>
              </li>
