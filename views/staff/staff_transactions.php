...
<div class="table-wrapper-scroll-y my-custom-scrollbar">
	<h1 style="font-weight: bold; text-transform: uppercase;">Coeus - Staff List of Transactions</h1>
  ...
  width="100%">
   ...
   <thead class="bg-dark text-white">
    <tr>
      <th colspan="15" style="text-align: center;"><h3>List of request accepted</h3></th>
    </tr>
  </thead>
  <thead>
    <tr>
      ...
      <th scope="col" width="150" style="margin-left: 50px; text-align: center;">Select All <input type="checkbox" id="selectAll1" style="margin-left: 5px;" /></th>
    </tr>
  </thead>
