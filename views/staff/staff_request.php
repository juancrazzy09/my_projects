...
<div class="table-wrapper-scroll-y my-custom-scrollbar">
	<h1 style="font-weight: bold; text-transform: uppercase;">Coeus - Staff List of Requests</h1>
  ...
  <tbody style="text-align: center;">
    ...
    <tr>
      ...
      <td><?= $row->end;?></td>
      <td><?= $row->sub_total;?></td>
      <td><a href="<?= site_url('admin/accept/'.$row->id); ?>" class="btn btn-sm btn-success">Accept</a></td>
      <td><a href="<?= site_url('admin/decline/'.$row->id); ?>" class="btn btn-sm btn-danger">Decline</a></td>
