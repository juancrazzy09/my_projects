            ...
            <div class="col-12 col-lg-10 offset-lg-1">
                <div class="row">
                    <div class="col-12">
                        <div class="text-center text-150">
                            ...
                            <span class="text-default-d3" style="font-weight: bold;">Receipt</span>
                        </div>
                    </div>
                </div>
                <!-- .row -->
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6" style="color: black;">
                        <div >
                            <span class="text-sm text-grey-m2 align-middle" style="color: black;">To:</span>
                    ...
                    <div class="text-95 col-sm-6 align-self-start d-sm-flex justify-content-end">
                        ...
                        <div class="text-grey-m2">
                            ...
                            <div class="my-2" style="color: black;"><i class="fa fa-circle text-blue-m2 text-xs mr-1"></i> <span class="text-600 text-90" style="color: black;">Status:</span> <span class="badge badge-warning badge-pill px-25">Unpaid</span></div>
                        </div>
                    </div>
                <?php } ?>
                    <!-- /.col -->
            ...
            -->
                    ...
                    <div class="row mt-3">
                        <div class="col-12 col-sm-7 text-grey-d2 text-95 mt-2 mt-lg-0">
                            Note: You only have 30 minutes to send the payment credentials. If the payment is not recieved the transaction will be automatically invalid.
                        </div>
                    ...
                    <div>
                        ...
                        <a href="<?= base_url();?>payment" class="btn btn-info btn-bold px-4 float-right mt-3 mt-lg-0">Pay Now</a>
                    </div>
                </div>
            </div>
        </div>
