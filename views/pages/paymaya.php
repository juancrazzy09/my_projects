<body class="body-design" style= "margin-bottom: 25%;  background-attachment: fixed; background-image: linear-gradient(rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.2)), url('http://localhost/coeus/img/bg2.jpg'";>
	<div class="container">
  ...
  <div class="card-body">
    <h6 class="pb-2" >Scan QR Code</h6>
       <img width="300" height="300" title="Paymaya" alt="Paymaya" src="<?php echo base_url('img/gcash.jpg');?>">
